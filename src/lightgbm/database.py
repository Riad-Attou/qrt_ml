...
class Database:
            ...
            for patient_id, patient_mutations in mutations_by_patient.items():
                ...
                for combo in itertools.combinations(patient_mutations, depth):
                    ...
                    for mutation in combo:
                        ...
                        combo_without = sorted([m.id for m in combo if m != mutation])
            ...
            for patient_id, patient_mutations in mutations_by_patient.items():
                ...
                for combo in combos:
                    ...
                    if key in self.mutations_classes:
                        ...
                        most_common_class, _ = Counter(classes_list).most_common(1)[0]
                ...
                if classes_for_patient:
                    ...
                    overall_class, _ = Counter(classes_for_patient).most_common(1)[0]
    ...
    def extract_mutations(self, df: pd.DataFrame, is_test: bool = False) -> list:
        """
